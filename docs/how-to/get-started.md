...
This guide was written for an older version of MonoGame. For now you can follow the [official MonoGame getting started guide](https://docs.monogame.net/articles/getting_started/0_getting_started.html).
...
3. Get the MonoGame Content Pipeline:
    ...
    ```
    > This step could take a while to complete since the pipeline is a pretty big file. If it looks like the terminal isn't doing anything, it's downloading in the background.
